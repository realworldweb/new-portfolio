...
loadProjects(){
 ...
 <picture>
  ...
  <img sizes="500px"  srcset="assets/images/${project[0].img.small.url} 650w" src="assets/images/${project[0].img.small.url}" class="card-img rounded" alt="${project[0].img.alt}" width="500" height="350">
 </picture>
